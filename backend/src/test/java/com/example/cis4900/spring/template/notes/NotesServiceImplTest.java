...
public class NotesServiceImplTest {
    ...
    @Test
    public void testGetNote_NotFound() {
        // Arrange
        when(notesDao.findById(1)).thenReturn(Optional.empty());

        // Act & Assert
        Exception exception = assertThrows(NoSuchElementException.class, () -> notesService.getNote(1));
